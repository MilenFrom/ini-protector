			...
			'traffic_log'         => array(
				...
				'fields' => array(
					...
					'max_rows'       => array(
						...
						'desc'    => 'A second, absolute ceiling on top of the window above: once the log passes this many requests the oldest go, whatever the retention says. Set a limit here if you want a hard stop on how large the log can ever get — but note it is the setting that runs out first, and on a busy site 50,000 requests can be less than a day, which would make a long retention window have no effect.',
					),
				),
			),
			'autoblock'           => array(
